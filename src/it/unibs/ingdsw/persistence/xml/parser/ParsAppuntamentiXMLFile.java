...
public class ParsAppuntamentiXMLFile {
    ...
    private static final String DATA = "appuntamenti.xml";
    ...
    public InsiemeAppuntamenti getAppuntamenti() {
        return new InsiemeAppuntamenti(new ArrayList<>(appuntamenti));
    }
    ...
    private void parseXML()
        ...
        for (int i = 0; i < nl.getLength(); i++) {
            ...
            if (statoStr != null && !statoStr.isBlank()) {
                try {
                    stato = StatoAppuntamento.valueOf(statoStr.trim().toUpperCase());
